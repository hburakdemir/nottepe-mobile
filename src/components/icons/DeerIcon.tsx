...
// Web'in avatar boşluğunda kullandığı @iconify "game-icons:deer-head" ikonunun
// KENDİSİ — path verisi api.iconify.design'dan (game-icons.net, MIT) alındı,
// react-native-svg ile birebir aynı glif çiziliyor (eskiden elle çizilmiş bir
// yaklaşık karşılığı vardı).
