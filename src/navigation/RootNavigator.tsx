...
export default function RootNavigator() {
  ...
  // ÇEVRİMDIŞI KİLİDİ ARTIK AĞACI DEĞİŞTİRMİYOR, ÜSTÜNE BİNİYOR.
  //
  ...
  // O yüzden `useIsOffline`'da 1,5 sn'lik bir debounce tutmak ZORUNDAYDIK —
  // ham okuma gerçek cihazda titriyor ve her titremede tüm ağaç yıkılıp
  // yeniden kuruluyordu. Bedeli kullanıcının bildirdiği gecikme: "internet
  // kapanınca 130 sayfasının gelmesi 2-3 sn sürüyor."
  //
  ...
  //
  // İkinci kazanç: öne dönüşte ağacın sıfırdan kurulma yollarından biri
  // tamamen kapandı — arka planda Wi-Fi uykuya alınıp kilit devreye girse bile
  // artık unmount yok.
  //
  ...
  // çevrimdışıyken sorgular DURAKLIYOR, istek atmıyor, dolayısıyla hata
  // ekranı da üretmiyor.
  //
  ...
  // da üstüne biniyor (yukarıdaki `withOfflineOverlay`), yani giriş ekranında
  // da çevrimdışıyken EGO 130 görünüyor. Kullanıcı isteği buydu: "internet
  // yokken uygulama açıldığında direkt 130 sayfasına yönlendirme yapmalı."
  if (!isAuthenticated) {
